...
namespace CS_Number_Shuffles
{
    public partial class Form1 : Form
    {
        ...
        public void SolutionChecker()
        {
            ...
            {
                MessageBox.Show("You Win","Shuffle Game",MessageBoxButtons.OK,MessageBoxIcon.Information);
            }
            Counter = Counter + 1;
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            EmptySpotChecker(button6, button11);
        ...
        {
            DialogResult iExit = MessageBox.Show
                ("Confirm if you want to exit", "Shuffle Games", MessageBoxButtons.YesNo, MessageBoxIcon.Information); 
        ...
        private void button19_Click(object sender, EventArgs e)
        {
            ...
            button16.Text = Convert.ToString("");
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            EmptySpotChecker(button5, button12);
        ...
        {
            EmptySpotChecker(button12, button5);
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            EmptySpotChecker(button11, button6);
            SolutionChecker();
        }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            EmptySpotChecker(button7, button10);
        ...
        {
            EmptySpotChecker(button10, button7);
